  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		...
		<br><br>
           <form class="form-inline" action="outofstock.php" method="post">
		   ...
		   if(isset($_POST['sub'])):
				...
				$qu = $db->query("SELECT food.name , outoforder.foodid, DAY(date) as day, MONTH(date) as month , YEAR(date) as year 
...
GROUP BY YEAR(date), MONTH(date), DAY(date), foodid;");
        ?>
				...
				<div class="col-md-6">       
					<h2 class="text-center">Out Of Order Menu Items</h2><hr>
				...
				<form method="post" action="outofstockp.php" target="_blank">
